    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_attribute', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.productattribute', verbose_name='Unité')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('code', models.CharField(blank=True, max_length=10, null=True, unique=True)),
                ('attributes', models.ManyToManyField(blank=True, null=True, related_name='product_item', to='app.productattributevalue')),
